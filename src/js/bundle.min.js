...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils */ \"./src/js/utils.js\");\n/* harmony import */ var _templates__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../templates */ \"./src/js/templates.js\");\n\n\nvar form = document.querySelector('.form');\nvar modal = document.querySelector('[data-modal=\"todo\"]');\nvar modalConfirm = document.querySelector('[data-modal=\"confirm\"]');\nvar closers = document.querySelectorAll('[data-close-modal]');\nvar closeAll = document.querySelector('[data-close-all]');\nvar btn = document.querySelector('.workplace__add');\nvar parent = document.querySelector('.workplace__inner');\nvar store = [];\n\nif (Object(_utils__WEBPACK_IMPORTED_MODULE_0__[\"getLocal\"])('tasks')) {\n  JSON.parse(Object(_utils__WEBPACK_IMPORTED_MODULE_0__[\"getLocal\"])('tasks')).forEach(function (_ref) {\n    var key = _ref.key,\n        pressed = _ref.pressed,\n        value = _ref.value;\n    store.push({\n      key: key,\n      pressed: pressed,\n      value: value\n    });\n    parent.insertAdjacentHTML('afterbegin', Object(_templates__WEBPACK_IMPORTED_MODULE_1__[\"render\"])(key, pressed, value));\n  });\n}\n\nbtn.addEventListener('click', function () {\n  Object(_utils__WEBPACK_IMPORTED_MODULE_0__[\"addActive\"])(modal);\n  Object(_utils__WEBPACK_IMPORTED_MODULE_0__[\"input\"])('.form__input').focus();\n});\nclosers.forEach(function (item) {\n  item.addEventListener('click', function (e) {\n    if (Object(_utils__WEBPACK_IMPORTED_MODULE_0__[\"input\"])('.form__input').getText()) {\n      Object(_utils__WEBPACK_IMPORTED_MODULE_0__[\"addActive\"])(modal);\n      Object(_utils__WEBPACK_IMPORTED_MODULE_0__[\"addActive\"])(modalConfirm);\n    } else {\n      Object(_utils__WEBPACK_IMPORTED_MODULE_0__[\"removeActive\"])(modal);\n    }\n\n    if (e.target.closest('.modal:not([data-modal=\"todo\"])')) {\n      Object(_utils__WEBPACK_IMPORTED_MODULE_0__[\"removeActive\"])(modalConfirm);\n    }\n  });\n});\ncloseAll.addEventListener('click', function () {\n  document.querySelectorAll('.modal').forEach(function (item) {\n    Object(_utils__WEBPACK_IMPORTED_MODULE_0__[\"removeActive\"])(item);\n  });\n  form.reset();\n});\nform.addEventListener('submit', function (e) {\n  e.preventDefault();\n  var text = Object(_utils__WEBPACK_IMPORTED_MODULE_0__[\"input\"])('.form__input').getText();\n  var utils = Object(_templates__WEBPACK_IMPORTED_MODULE_1__[\"todo\"])(text);\n\n  if (text) {\n    parent.insertAdjacentHTML('afterbegin', utils.generate());\n    store.push(utils.data());\n    Object(_utils__WEBPACK_IMPORTED_MODULE_0__[\"setLocal\"])('tasks', JSON.stringify(store));\n    Object(_utils__WEBPACK_IMPORTED_MODULE_0__[\"removeActive\"])(modal);\n    form.reset();\n    Object(_utils__WEBPACK_IMPORTED_MODULE_0__[\"activatePopup\"])('.popup-badge', _templates__WEBPACK_IMPORTED_MODULE_1__[\"message\"].add);\n  } else {\n    Object(_utils__WEBPACK_IMPORTED_MODULE_0__[\"activatePopup\"])('.popup-badge', _templates__WEBPACK_IMPORTED_MODULE_1__[\"message\"].notEmpty);\n  }\n});\nparent.addEventListener('click', function (e) {\n  var t = e.target;\n  var item = t.closest('.workplace__item');\n\n  if (t.matches('.workplace__item-image')) {\n    var id = item.dataset.key;\n    var itemNum = store.findIndex(function (item) {\n      return item.key === id;\n    });\n    store.splice(itemNum, 1);\n    Object(_utils__WEBPACK_IMPORTED_MODULE_0__[\"setLocal\"])('tasks', JSON.stringify(store));\n    item.remove();\n    Object(_utils__WEBPACK_IMPORTED_MODULE_0__[\"activatePopup\"])('.popup-badge', _templates__WEBPACK_IMPORTED_MODULE_1__[\"message\"].remove);\n  }\n\n  if (t.matches('.workplace__item-text') && t.previousElementSibling.checked) {\n    var _id = item.dataset.key;\n\n    var _itemNum = store.findIndex(function (item) {\n      return item.key === _id;\n    });\n\n    store[_itemNum].pressed = false;\n    Object(_utils__WEBPACK_IMPORTED_MODULE_0__[\"setLocal\"])('tasks', JSON.stringify(store));\n  } else if (t.matches('.workplace__item-text') && !t.previousElementSibling.checked) {\n    var _id2 = item.dataset.key;\n\n    var _itemNum2 = store.findIndex(function (item) {\n      return item.key === _id2;\n    });\n\n    store[_itemNum2].pressed = true;\n    Object(_utils__WEBPACK_IMPORTED_MODULE_0__[\"setLocal\"])('tasks', JSON.stringify(store));\n  }\n});\nwindow.addEventListener('keyup', function (e) {\n  if (e.code === 'KeyT') {\n    Object(_utils__WEBPACK_IMPORTED_MODULE_0__[\"addActive\"])(modal);\n    Object(_utils__WEBPACK_IMPORTED_MODULE_0__[\"input\"])('.form__input').focus();\n  }\n});\n\n//# sourceURL=webpack:///./src/js/modules/todo.js?");
...
/*!*************************!*\
  !*** ./src/js/utils.js ***!
  \*************************/
/*! exports provided: addActive, removeActive, input, activatePopup, setLocal, getLocal */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
