...
eval("\n\n//# sourceURL=webpack:///./src/js/modules/badge.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils */ \"./src/js/utils.js\");\n\nvar equalizer = document.querySelector('.menu__equalizer');\nvar popup = document.querySelector('.menu__popup-outer');\nvar showShortcuts = document.querySelector('[data-open=\"shortcuts\"]');\nvar showShortcutsContainer = document.querySelector('[data-modal=\"shortcuts\"]'); // const closeUIModals = document.querySelectorAll('[data-close-ui-modal]');\n\nequalizer.addEventListener('click', function () {\n  popup.classList.toggle('active');\n}); // showShortcuts.addEventListener('click', () => {\n//   showShortcutsContainer.classList.add('active');\n// });\n// closeUIModals.forEach((item) => {\n//   item.addEventListener('click', (e) => {\n//     removeActive(e.target.closest('[data-modal]'));\n//   });\n// });\n\n//# sourceURL=webpack:///./src/js/modules/equalizer.js?");
